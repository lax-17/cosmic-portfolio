          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
                <span className="text-2xl font-bold text-blue-600 dark:text-blue-400">LN</span>
              </div>
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Laxmikant Nishad</h1>
                <p className="text-gray-600 dark:text-gray-300">AI/ML Engineer</p>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">June 2025 - Present</p>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                ...
                <p className="text-blue-600 dark:text-blue-400 mb-2">Sheffield Hallam University</p>
                <p className="text-gray-600 dark:text-gray-300 mb-4">Feb 2025 - Aug 2025</p>
                <p className="text-gray-700 dark:text-gray-300">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">Oct 2023 - Dec 2023</p>
                <p className="text-gray-700 dark:text-gray-300">
